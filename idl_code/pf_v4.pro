pro Pf_v4
  ...
  ;One input is worldclim a0 precip (1 layer)
  ...
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V4\'
  output_prefix ='Pf.V4.'
  ...
  For h = 167, input_nfilename - 1 Do Begin
    ...
    ; For transform 8   :   ((var_1_raster[a,b] - var_1_raster_alt[a,b]) + var_1_adjustment_factor)^0.5  (with an alat variable)
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_2_raster[a,b] NE no_data_value and var_1_raster_alt[a,b] NE no_data_value Then Begin
          output_raster[a,b] = ((var_1_raster[a,b] - var_1_raster_alt[a,b]) + var_1_adjustment_factor)^0.5 * alog10((var_2_raster[a,b] + var_2_adjustment_factor))
