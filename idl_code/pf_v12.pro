pro Pf_v12
  ...
  ;Malaria variable #12
  ;This is a per-month (150? layer) product 
  ;One input is static, one is monthly dynamic
  ...
  input_path_1 = 'F:\5km_mastergrid_aligned\LST_delta\mean\'
  ...
  input_file_2 = 'F:\5km_mastergrid_aligned\Topographic\Africa_slope_90m.slope.threshold.2deg.tif'
  
  ; Define output information
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V12\'
  output_prefix ='Pf.V12.'
  ...
  var_1_adjustment_factor = 2.32997
  ...
  var_2_mean = 1.656641018
  var_2_stdev = 0.356452718
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_2_raster[a,b] NE no_data_value Then Begin
          v1 = (var_1_raster[a,b] + var_1_adjustment_factor)^2
          v2 = ABS(((var_2_raster[a,b] + var_2_adjustment_factor) - var_2_mean) / var_2_stdev)
