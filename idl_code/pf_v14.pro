pro Pf_v14
  ...
  ;V1 is dynamic with an adjust (anomaly), v2 is an annual product from 2001
  ...
  input_suffix_2 = '.fraction.class.14.tif'
  ;input_file_2 = 'F:\5km_mastergrid_aligned\worldclim\prec57a0.tif'
  
  ; Define output information
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V14\'
  output_prefix ='Pf.V14.'
  ...
  var_1_adjustment_factor = 9.24834
  ...
  For h = 166, input_nfilename - 1 Do Begin 
    ...
    If long(year) GE 2013 Then input_filename_var_2 = 'F:\5km_mastergrid_aligned\IGBP_landcover\2012.fraction.class.14.tif' Else input_filename_var_2 = input_path_2 + year + input_suffix_2
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_2_raster[a,b] NE no_data_value and var_1_raster_alt[a,b] NE no_data_value Then Begin
          v1 =  ((var_1_raster[a,b] - var_1_raster_alt[a,b]) + var_1_adjustment_factor)
