pro Pf_v16
  ...
  ;Both variables are monthly synoptic
  ...
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V16\'
  output_prefix ='Pf.V16.'
  ...
  var_1_BoxCox = -0.399426271
  ;var_2_mean = 1784.56696
  ;var_2_stdev = 246.0924325

  var_1_lag = 2 ; same lag on both vars
  ...
  For h = 0, input_nfilename - 2 Do Begin ; -2 to skip the annual summary
    ...
    input_filename_var_2 = input_path_2 + month + input_suffix_2

    ENVI_OPEN_FILE, input_filename_var_2, r_fid = fid_input
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_2_raster[a,b] NE no_data_value  AND var_1_raster[a,b] NE 0.0 Then Begin
          v1 = (var_1_raster[a,b] + var_1_adjustment_factor)^var_1_BoxCox
          
          v2 =  (var_2_raster[a,b] + var_1_adjustment_factor)
          If v2 LT ratio_threshold Then v2 = 1/ratio_threshold Else v2 = 1/v2
          ...
          ;  halt
          ;EndIf
          ;if t3 GT 500 or t3 LT 0 then halt
