pro Pf_v7
  ...
  ;Malaria variable #7
  ; Both vars monthly with lags
  ; the first var is an anomaly (minus a static layer)
  ...
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V7\'
  output_prefix ='Pf.V7.'
  ...
  var_1_adjustment_factor = 1.25796
