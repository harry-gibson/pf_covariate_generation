pro Pf_v20
  ...
  ;Malaria variable #20
  ;V1 is dynamic with a lag, v2 is an annual product from 2001-2012
  ...
  input_path_1 = 'F:\5km_mastergrid_aligned\TCW\stdev\
  input_suffix_1 = '.stdev.tif'
  ...
  input_suffix_2 = '.fraction.class.13.tif'
  ;input_file_2 = 'F:\5km_mastergrid_aligned\worldclim\prec57a0.tif'
  
  ; Define output information
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V20\'
  output_prefix ='Pf.V20.'
  ...
  var_1_lag = 3 
  ;var_2_lag = 1 ; the real lag is 3, the 1 is for he difference between the lags
  ...
  var_1_BoxCox = -0.202754798
  ;var_2_mean = 
  ;var_2_stdev = 
  ;var_2_BoxCox = -2.590456195

  For h = 164, input_nfilename - 1 Do Begin 
    ...
    ;If month_var_2_long GT 12 Then Begin
    ...
    ;Construct the var_2 name (use 2001 data for 2000, since not landcover for 2000
    If long(year_output) EQ 2000 Then input_filename_var_2 = 'F:\5km_mastergrid_aligned\IGBP_landcover\2001.fraction.class.13.tif' Else input_filename_var_2 = input_path_2 + year_output + input_suffix_2 
    If long(year_output) GE 2013 Then input_filename_var_2 = 'F:\5km_mastergrid_aligned\IGBP_landcover\2012.fraction.class.13.tif' Else input_filename_var_2 = input_path_2 + year_output + input_suffix_2
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE 0.0 Then Begin
          v1 =  (var_1_raster[a,b] + var_1_adjustment_factor)^var_1_BoxCox
          ;If v1 LT ratio_threshold Then v1 = 1/ratio_threshold Else v1 = 1/v1
          ...
          ;  halt
          ;EndIf
          ;If t3 GT 1000 or t3 LT 0.0 Then halt
