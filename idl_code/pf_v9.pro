pro Pf_v9
  ...
  ;Malaria variable #9
  ;This is a per-month (12 layer) product 
  ...
  input_path_1 = 'F:\5km_mastergrid_aligned\LST_day\max\'
  ...
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V9\'
  output_prefix ='Pf.V9.'
  ...
  For h = 0, input_nfilename - 2 Do Begin ; minus 2 to skip the annual synoptic .tif
