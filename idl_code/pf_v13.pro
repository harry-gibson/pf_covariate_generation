pro Pf_v13
  ...
  ;Doubly dynamic with an adjust (anomaly) on var 1
  ...
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V13\'
  output_prefix ='Pf.V13.'
  ...
  var_1_adjustment_factor = 1.24469
  ...
  ;var_2_mean = 
  ;var_2_stdev = 
  var_2_BoxCox = -1.477884545

  ;For h = 1, input_nfilename - 2 Do Begin ; start on 1 due to no TSI data that early.  -2 = same reasoning
  For h = 166, input_nfilename - 2 Do Begin ; start on 1 due to no TSI data that early.  -2 = same reasoning
    ...
    input_filename_var_2 = input_path_2 + year_var_2 + '.' + month_var_2 + input_suffix_2 
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_2_raster[a,b] NE no_data_value and var_1_raster_alt[a,b] NE no_data_value AND var_2_raster[a,b] NE 0.0 Then Begin
          v1 =  ((var_1_raster[a,b] - var_1_raster_alt[a,b]) + var_1_adjustment_factor)^2
