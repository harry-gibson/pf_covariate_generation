pro Pf_v17
  ...
  ;Malaria variable 17
  ; One dynamic, one synoptic, no alt rasters, matching lags
  ...
  input_path_1 = 'F:\5km_mastergrid_aligned\LST_night\min\synoptic\'
  ...
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V17\'
  output_prefix ='Pf.V17.'
  ...
  var_2_adjustment_factor = 7.87137
  
  var_1_lag = 4 ; the matches the var 2 lag
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] GT 0.0 AND var_2_raster[a,b] NE no_data_value Then Begin ;and var_1_raster_alt[a,b] NE no_data_value AND var_2_raster[a,b] NE 0.0 Then Begin
          v1 =  alog10((var_1_raster[a,b] + var_1_adjustment_factor))
