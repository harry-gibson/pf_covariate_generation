pro Pf_v11
  ...
  input_path_1 = 'F:\5km_mastergrid_aligned\TSI\mean\'
  ...
  input_file_2 = 'F:\5km_mastergrid_aligned\Poverty\PET_1950-2000_5km.mean.tif'
  
  ; Define output information
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V11\'
  output_prefix ='Pf.V11.'
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_2_raster[a,b] NE no_data_value Then Begin
          v1 = ((var_1_raster[a,b] + var_1_adjustment_factor) - var_1_mean) / var_1_stdev
