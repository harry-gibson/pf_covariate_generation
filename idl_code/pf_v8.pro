pro Pf_v8
  ...
  ;Malaria variable #7
  ; Both vars monthly, no lags, one dynamic, one synoptic
  ...
  input_path_1 = 'F:\5km_mastergrid_aligned\TCB\range\
  ...
  input_path_2 = 'F:\5km_mastergrid_aligned\LST_delta\max\'
  input_suffix_2 = '.max.tif'
  ;input_file_2_alt = 'F:\5km_mastergrid_aligned\LST_delta\max\annual.synoptic.mean.tif'
  
  ; Define output information
  output_path = 'F:\5km_mastergrid_aligned\Pf_cubes\V8\'
  output_prefix ='Pf.V8.'
  ...
  var_2_adjustment_factor = 1.15477
  
  ;var_1_lag = 3
  ;var_2_lag = 1 ; var 2 has an even greater lag than var 1
  ...
  var_2_mean = 15.15094009
  var_2_stdev = 5.559321971
  ;var_1_BoxCox = 
  ...
  For h = 166, input_nfilename - 1 Do Begin
    ...
    For a = 0, ns_template -1 Do Begin
      For b = 0, nl_template -1 Do Begin
        If template_raster[a,b] NE no_data_value AND var_1_raster[a,b] NE no_data_value AND var_2_raster[a,b] NE no_data_value Then Begin ;and var_1_raster_alt[a,b] NE no_data_value AND var_2_raster[a,b] NE 0.0 Then Begin
          v1 = (var_1_raster[a,b] + var_1_adjustment_factor)
          If v1 LT ratio_threshold Then v1 = ratio_threshold Else v1 = 1/v1
          v2 = ((var_2_raster[a,b] + var_2_adjustment_factor) - var_2_mean) / var_2_stdev
